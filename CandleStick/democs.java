...
public class democs extends ApplicationFrame
{

    public democs(String s)
    {
        super(s);
    ...
    private static JFreeChart createChart(OHLCDataset ohlcdataset)
    {
      ...
      //---Set UP and DOWN bar chart color---
      ...
      //candlestickRenderer.setUseOutlinePaint(Color.BLUE); 
      xyplot.setRenderer(0, candlestickRenderer);
    ...
    {
        democs candlestickchartdemo1 = new democs("Candlestick Demo");
